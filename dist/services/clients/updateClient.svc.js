...
const updateClientService = (id, data, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (data.email) {
        const emailIsUnavailable = yield clientRepository.getClientbyEmail(data.email);
    ...
    yield clientRepository.updateClient(id, data);
    return "Client Updated Successfully";
});
exports.default = updateClientService;
//# sourceMappingURL=updateClient.svc.js.map